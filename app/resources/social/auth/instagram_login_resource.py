...
# =========================================
# SET PASSWORD (for Instagram users)
# =========================================
@blp_instagram_login.route("/auth/instagram/set-password", methods=["POST"])
class InstagramSetPasswordResource(MethodView):
    """
    Set a password for users who signed up via Instagram Login.
    ...
    def post(self):
        ...
        def _post():
            ...
            client_ip = request.remote_addr
            log_tag = f"[instagram_login_resource.py][InstagramSetPasswordResource][{client_ip}][{user__id}]"
...
# =========================================
@blp_instagram_login.route("/auth/instagram/account-status", methods=["GET"])
class InstagramAccountStatusResource(MethodView):
    """
    ...
    def get(self):
        ...
        def _get():
            ...
            client_ip = request.remote_addr
            log_tag = f"[instagram_login_resource.py][InstagramAccountStatusResource][{client_ip}][{business_id}]"
            ...
            has_instagram = bool(user_doc.get("instagram_user_id"))
            social_provider = user_doc.get("social_login_provider")
            has_password = bool(user_doc.get("password"))
            registered_via_social = social_provider in ["facebook", "google", "apple", "instagram"]
            ...
            if has_instagram:
                instagram_info = {
                    "instagram_user_id": user_doc.get("instagram_user_id"),
                    "instagram_username": user_doc.get("instagram_username"),
                }
