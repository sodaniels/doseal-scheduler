...
class FacebookDiscoverMetricsResource(MethodView):
    ...
    def get(self):
        ...
        # Discover metrics
        discovery = _discover_valid_metrics(
            page_id=page_id,
            access_token=access_token,
            log_tag=log_tag,
        )
        ...
        return jsonify({
            ...
            "data": {
                ...
                "discovery": discovery,
                "recommendation": (
                    "Use the metrics in 'working_metrics'. "
                    "If empty, your token may be missing 'read_insights' permission. "
                    "Reconnect with permissions: read_insights, pages_read_engagement"
                ),
            }
        }), HTTP_STATUS_CODES["OK"]
