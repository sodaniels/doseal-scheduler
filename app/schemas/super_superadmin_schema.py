import re
import uuid
from marshmallow import Schema, fields, validate, ValidationError, validates, INCLUDE
...
class SubscribersSchema(Schema):
    ...
    business_id = fields.Str(
        required=True,
        validate=validate_objectid, 
        description="business ID of the Business to fetch detail."
    )
...
class SubscriberQuerySchema(Schema):
    subscriber_id = fields.Str(required=True, validate=validate_objectid, description="Subscriber ID of the User to fetch detail.")
